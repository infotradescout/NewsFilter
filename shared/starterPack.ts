...
export const STARTER_TOPIC_PRESETS: StarterTopicPreset[] = [
  {
    ...
    name: "Macro: Rates & Inflation Pulse",
    category: "macro",
    window: "24h",
    ...
    description: "Fed, inflation, and labor data that shift rates expectations.",
  },
  {
    key: "commodities-energy-metals",
    name: "Commodities: Energy & Metals Shock",
    category: "commodities",
    window: "24h",
    ...
    description: "Energy and metals events with immediate market impact.",
  },
  {
    key: "equities-earnings-risk",
    name: "Equities: Earnings & Guidance Risk",
    category: "equities",
    window: "24h",
    ...
    description: "Company-level catalysts likely to move stocks.",
  },
  {
    key: "crypto-etf-liquidity",
    name: "Crypto: ETF Flow & Liquidity",
    category: "crypto",
    window: "24h",
    ...
    description: "Crypto headlines tied to flows, liquidity, and regulation.",
  },
];
